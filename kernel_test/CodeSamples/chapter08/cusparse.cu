...
int main(int argc, char **argv) {
  ...
  if (totalNnz != trueNnz) {
    fprintf(stderr,
            "Difference detected between cuSPARSE NNZ and true "
  ...
  CHECK_CUSPARSE(cusparseScsrmv(handle, CUSPARSE_OPERATION_NON_TRANSPOSE, M, N,
                                totalNnz, &alpha, descr, dCsrValA, dCsrRowPtrA,
