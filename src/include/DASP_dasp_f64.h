...
// #include "DASP_common.h"
// #include "DASP_utils.h"
...
// __device__ __forceinline__ MAT_VAL_TYPE
// load_double_from_global(const MAT_VAL_TYPE *a) {
//   MAT_VAL_TYPE r;
//   asm volatile("ld.global.cs.f64 %0, [%1];" : "=d"(r) : "l"(a));
//   return r;
// }

// __device__ __forceinline__ void store_double_to_global(const MAT_VAL_TYPE *a,
//                                                        MAT_VAL_TYPE v) {
...
// __global__ void
// dasp_spmv(MAT_VAL_TYPE *dX_val, MAT_VAL_TYPE *dY_val, MAT_VAL_TYPE
// *dlongA_val,
//           int *dlongA_cid, MAT_VAL_TYPE *dwarp_val, MAT_PTR_TYPE *dlongA_rpt,
//           int row_long, MAT_VAL_TYPE *dregA_val, int *dregA_cid,
//           MAT_PTR_TYPE *dblockA_ptr, int row_block, int blocknum,
//           MAT_VAL_TYPE *dirregA_val, int *dirregA_cid,
//           MAT_PTR_TYPE *dirregA_rpt, MAT_VAL_TYPE *dshort_val, int
//           *dshort_cid, int short_row_1, int common_13, int short_row_34, int
//           short_row_2, int offset_reg, int offset_short1, int offset_short13,
//           int offset_short34, int offset_short22,
...
//     int len =
//         load_int_from_global(dlongA_rpt + global_warpid + 1) - offset_longA;
...
//         store_double_to_global(dY_val + row_long + offset_y,
//                                fragC[1 & groupID]);
//       }
...
//         {
//           cur_y +=
//               load_double_from_global(dirregA_val + i) *
//               dX_val[dirregA_cid[i]];
//         }
...
//         if ((laneid >> 3) == i)
//           res = (1 & laneid) == 0 ? fragC[0] : fragC[1];
//       }
...
//     MAT_VAL_TYPE temp_y =
//         load_double_from_global(dshort_val + tid1) * dX_val[x_idx];
...
//       int offset = short_row_1 +
//                    ((bid13 * groupNum + i) * warpNum_short + warpid_local) *
//                        MMA_M * MMA_K * 2;
...
//       int offset_y =
//           ((bid13 * groupNum + i) * warpNum_short + warpid_local) * WARP_SIZE
//           + laneid;
//       if (offset_y < common_13 * 2)
//         store_double_to_global(
//             dY_val + row_long + row_block + short_row_1 + offset_y, res);
//     }
...
//       int offset = short_row_1 + fill0_nnz_short13 +
...
//         store_double_to_global(dY_val + row_long + row_block + short_row_1 +
//                                    common_13 * 2 + offset_y,
//                                res);
//     }
//   } else {
...
// #pragma unroll
//     for (int i = 0; i < groupNum; i++) {
//       int offset = short_row_1 + fill0_nnz_short13 + fill0_nnz_short34 +
//                    ((bid22 * groupNum + i) * warpNum_short + warpid_local) *
//                        MMA_M * MMA_K * 2;
//       MAT_VAL_TYPE *cur_val = dshort_val + offset;
//       int *cur_cid = dshort_cid + offset;
//       int idx = tID_in_group + groupID * MMA_K;
...
//         store_double_to_global(dY_val + row_long + row_block + short_row_1 +
//                                    common_13 * 2 + short_row_34 + offset_y,
//                                res);
//     }
//   }
// }

// __host__ void spmv_all(char *filename, MAT_VAL_TYPE *csrValA,
//                        MAT_PTR_TYPE *csrRowPtrA, int *csrColIdxA,
//                        MAT_VAL_TYPE *X_val, MAT_VAL_TYPE *Y_val, int
//                        *order_rid, int rowA, int colA, MAT_PTR_TYPE nnzA, int
//                        NUM, double threshold, int block_longest, double
//                        *dasp_pre, double *dasp_time, double *dasp_gflops,
//                        double *dasp_bandwidth) {
...
//     }
//   }
//   nnz_short = short_row_1 + short_row_3 * 3 + short_row_2 * 2 + short_row_4 *
//   4;
...
//   int threadblock13 =
//       (short_block13 + block13_per_threadblock - 1) /
//       block13_per_threadblock;
//   int threadblock22 =
//       (short_block22 + block22_per_threadblock - 1) /
//       block22_per_threadblock;
//   int threadblock34 =
//       (short_block34 + block34_per_threadblock - 1) /
...
//   MAT_PTR_TYPE fill0_nnz_short =
//       short_row_1 + fill0_nnz_short13 + fill0_nnz_short34 +
//       fill0_nnz_short22;
...
//     MAT_VAL_TYPE *cur_short_val = short_val + short_row_1 + i * MMA_M *
//     MMA_K; int *cur_short_cid = short_cid + short_row_1 + i * MMA_M * MMA_K;
...
//         short_val + short_row_1 + fill0_nnz_short13 + i * MMA_K;
//     int *cur_short_cid =
//         short_cid + short_row_1 + fill0_nnz_short13 + i * MMA_K;
...
//     MAT_VAL_TYPE *cur_short_val =
//         short_val + short_row_1 + fill0_nnz_short13 + (short_row_3 + i) *
//         MMA_K;
//     int *cur_short_cid =
//         short_cid + short_row_1 + fill0_nnz_short13 + (short_row_3 + i) *
//         MMA_K;
...
//     MAT_VAL_TYPE *cur_short_val = short_val + short_row_1 + fill0_nnz_short13
//     +
//                                   fill0_nnz_short34 + i * MMA_M * MMA_K;
//     int *cur_short_cid = short_cid + short_row_1 + fill0_nnz_short13 +
//                          fill0_nnz_short34 + i * MMA_M * MMA_K;
//     const int end_j = min(BlockSize << 1, short_row_2 - i * BlockSize * 2);

//     for (int j = 0; j < end_j; j++) {
//       const int cur_row = short_rid_2[i * BlockSize * 2 + j];
//       cur_short_val[j % BlockSize * MMA_K + (j / BlockSize) * 2] =
//           csrValA[csrRowPtrA[cur_row]];
//       cur_short_val[j % BlockSize * MMA_K + (j / BlockSize) * 2 + 1] =
//           csrValA[csrRowPtrA[cur_row] + 1];
//       cur_short_cid[j % BlockSize * MMA_K + (j / BlockSize) * 2] =
//           csrColIdxA[csrRowPtrA[cur_row]];
//       cur_short_cid[j % BlockSize * MMA_K + (j / BlockSize) * 2 + 1] =
//           csrColIdxA[csrRowPtrA[cur_row] + 1];
//     }
//   }
...
// #pragma omp parallel for
//       for (int i = 0; i < short_row_3; i++) {
//         order_rid[row_long + row_block + short_row_1 + common_13 * 2 + i] =
...
// #pragma omp parallel for
//       for (int i = 0; i < short_row_4; i++) {
//         order_rid[row_long + row_block + short_row_1 + common_13 * 2 +
//                   short_row_3 + i] = short_rid_4[i];
//       }
//     }
...
//         order_rid[row_long + row_block + short_row_1 + common_13 * 2 +
//                   short_row_3 + short_row_4 + i] = short_rid_2[i];
//       }
//     }
...
//         order_rid[row_long + row_block + short_row_1 + common_13 * 2 +
//                   short_row_3 + short_row_4 + short_row_2 + i] = zero_rid[i];
//       }
//     }
// #pragma omp section
//     {
...
//       for (int i = 0; i < short_block13; i++) {
//         int *cur_order_rid =
//             order_rid + row_long + row_block + short_row_1 + i * BlockSize *
//             2;
...
//   for (int i = 0; i < row_long; i++) {
//     long_rpt_new[i + 1] =
//         (long_rpt[i + 1] - long_rpt[i] + MMA_M * MMA_K * loopNum_long - 1) /
//         (MMA_M * MMA_K * loopNum_long);
//   }
...
//   int BlockNum_long =
//       (long_rpt_new[row_long] + warpNum_long - 1) / warpNum_long;
//   int fill0_nnz_long =
//       BlockNum_long * warpNum_long * loopNum_long * MMA_M * MMA_K;
...
//         long_val + long_rpt_new[i] * loopNum_long * MMA_M * MMA_K;
...
//       (MAT_VAL_TYPE *)malloc(sizeof(MAT_VAL_TYPE) * nnz_irreg);
...
//           temp_cid[regA_start + i] = i < row_len ? csrColIdxA[A_start + i] :
//           0;
//         }
//       } else {
//         for (int i = 0; i < blocklen; i++) {
...
//   long fill0_nnz = fill0_nnz_short + fill0_nnz_long + nnz_irreg +
//   fill0_nnz_reg; double rate_fill0 = (double)(fill0_nnz - nnzA) / nnzA;
...
//       nnz_irreg * (sizeof(MAT_VAL_TYPE) + sizeof(int)) +
...
//   int BlockNum_short_1 = (short_row_1 + ThreadNum_short - 1) /
//   ThreadNum_short; int BlockNum_short =
...
//   cudaMemcpy(dX_val, X_val, sizeof(MAT_VAL_TYPE) * colA,
...
//   cudaMalloc((void **)&dlong_ptr_warp, sizeof(MAT_PTR_TYPE) * (row_long +
//   1)); cudaMemcpy(dlong_val, long_val, sizeof(MAT_VAL_TYPE) * fill0_nnz_long,
//              cudaMemcpyHostToDevice);
...
//   cudaMemcpy(dirreg_val, irreg_val, sizeof(MAT_VAL_TYPE) * nnz_irreg,
//              cudaMemcpyHostToDevice);
...
//       dasp_spmv<1>, cudaFuncAttributePreferredSharedMemoryCarveout,
//       carveout);
//   cudaFuncSetAttribute(
//       dasp_spmv<2>, cudaFuncAttributePreferredSharedMemoryCarveout,
//       carveout);
//   cudaFuncSetAttribute(
//       dasp_spmv<4>, cudaFuncAttributePreferredSharedMemoryCarveout,
//       carveout);
//   if (rowloop == 1) {
//     for (int i = 0; i < 100; ++i) {
